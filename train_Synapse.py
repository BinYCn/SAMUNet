...
parser.add_argument(
    '--root_path',
    type=str,
    default='data/Synapse/train_npz_new_224',
...
parser.add_argument('--AdamW', type=bool, default=True,
                    help='If activated, use AdamW to finetune SAM model')
...
if __name__ == "__main__":
    ...
    trainer[dataset_name](args, net, snapshot_path, args.split)
